						...
						return html`
							<div class="form-group">
								...
								>
									...
									<option value="捶打">捶打</option>
									<option value="绷住">绷住</option>
									<option value="电眼">电眼</option>
									<option value="偷袭">偷袭</option>
									<option value="急了">急了</option>
									<option value="AOE">AOE</option>
									<option value="硬撑">硬撑</option>
									<option value="PUA">PUA</option>
									<option value="雷霆">雷霆</option>
